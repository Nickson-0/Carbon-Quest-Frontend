...
function SmallShow(mark, imageUrl, backgroundColor) {
  return (
    <Box className="small-dollar" sx={{ background: backgroundColor }}>
      <span className="small-dollar-span">{mark} </span>
